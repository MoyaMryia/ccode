...
/* Workspace / change-log state owned by agent_fs.c. */
extern char workspace_root[4096];
extern int workspace_dir_fd;
extern struct ccode_change change_log[CCODE_MAX_CHANGES];
extern int change_count;
extern struct ccode_task task_list[CCODE_MAX_TASKS];
extern int task_count;
extern int ccode_respect_gitignore_cached;
